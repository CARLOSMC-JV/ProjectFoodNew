...
export default {
    data(){
        return{
            form: useForm({
                    name: this.class_category.name,
                }),
        }
    },
    props:{
            class_category: {type: Object}
        },
    components:{
        Head,
        AuthenticatedLayout,
...
<template>
    <Head title="Editar Categoria Superior" />
<!-- 
    <AuthenticatedLayout>
        <template #header>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="p-4 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <form @submit.prevent="$event=>form.put(route('class_categories.update', class_category))" class="mt-2 space-y-6 max-w-sm">
                            <InputLabel for="name" value="Categoria Superior"></InputLabel>
                            ...
                            <PrimaryButton :disbled="form.processing">
                                <i class="fa fa-solid fa-save"></i>Guardar
                            </PrimaryButton>
                        </form>
                    </div>
                </div>
